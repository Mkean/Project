...
import com.bwie.project.adapter.WeiAdapter;
...
public class Fragment_Wei extends LazyFragment implements OrdersView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_wei, container, false);
    ...
    private void initView() {
        lv = view.findViewById(R.id.wei_lv);
    }
    ...
    public void onSuccess(List<OrdersBean.DataBean> data) {
        ...
        if (list.size() <= 0) {
            ...
            adapter = new WeiAdapter(list, getContext(), uid);
